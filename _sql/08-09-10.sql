...
--
-- Хост: localhost
-- Время создания: Сен 08 2010 г., 03:20
...
(2, 'Авторизация', 'option=com_login', 0, 0, 'option=com_login', 'wqewe', 'com_login', 0, 'administrator/images/menu/icon-16-clear.png', 0, '');
...
(2, 'mainmenu', 'Страницке', '', 'index.php?option=com_pages', 'components', 1, 0, 1, 0, 0, 0, '0000-00-00 00:00:00', 0, 0, 0, 0, '{ "page_id": "1" }');
