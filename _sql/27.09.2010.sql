...
--
-- Хост: localhost
-- Время создания: Сен 27 2010 г., 05:35
...
(1, 'Joostina TEAM', 0.1, 'Странички', 'pages', 0, 'administrator/images/menu/icon-16-featured.png', '', 0, ''),
(2, 'Joostina TEAM', 1.01, 'Авторизация', 'login', 0, 'administrator/images/menu/icon-16-clear.png', NULL, 0, '');
...
(1, 'Вот страничка!', 'Этот титл, он может без Б отличаться от заголовка, хехе', 'about', '<p>Тут можно текст, с <strong>форматированием</strong>!</p><p>И, не поверите, но даже так!</p><p><br></p>  ', 'META::keywords', 'META::description', '2010-09-04 03:53:30', 1),
(2, 'Страница номер два', '', '', 'Опачкикракарушки!', '', '', '2010-09-08 02:46:35', 1);
...
(1, 'Комментарии', 'Тыц-мегатыц', 'index2.php?option=comments', 'gwibber.png', 5, 1, 8),
(2, 'Редактор меню', '', 'index2.php?option=menumanager', 'revert.png', 9, 1, 8),
(3, 'Пользователи', '', 'index2.php?option=users', 'access.png', 10, 1, 8),
(4, 'Странички', '', 'index2.php?option=pages', 'stock_copy.png', 0, 1, 4),
(33, 'Файловый манипулятор', '', 'index2.php?option=finder', 'harddrive.png', 0, 1, 1),
(31, 'Блог', '', 'index2.php?option=blog', 'xfce4-menueditor.png', 0, 1, 1),
(32, 'БазаФакер', '', 'index2.php?option=faker', 'cab_extract.png', 0, 1, 1),
(6, 'Глобальная конфигурация', '', 'index2.php?option=config&hidemainmenu=1', 'application-default-icon.png', 13, 1, 8),
(7, 'Очистить весь кэш', '', 'index2.php?option=com_admin&task=clean_all_cache', 'reload.png', 14, 1, 8),
(30, 'Кодер', '', 'index2.php?option=coder', 'pup.png', 0, 1, 8),
(34, 'Новости', '', 'index2.php?option=news', 'edit-select-all.png', 0, 1, 1),
(35, 'SQL манипулятор', '', 'index2.php?option=phpminiadmin', 'drive-removable-media.png', 0, 1, 1),
(36, 'SQL резерватор', '', 'index2.php?option=sqldump', 'filesaveas.png', 0, 1, 1),
(37, 'Корзина', '', 'index2.php?option=trash', 'edittrash.png', 0, 1, 1);
...
(1, 'admin', 'info@joostina.ru', '', 'cfd23caa58ec2d7d07fc5a293d75f43e:Z21Rlz9aN0pDwGIg', 1, 8, 'SuperAdministrator', '2010-05-20 02:45:14', '2010-09-24 02:08:22', '0', 0);
...
INSERT INTO `jos_users_extra` (`user_id`, `realname`, `gender`, `about`, `location`, `site`, `icq`, `skype`, `jabber`, `twitter`, `yahoo`, `phone`, `fax`, `mobil`, `birthdate`, `cache_bookmarks`, `cache_votes`) VALUES
(1, '', '', NULL, '', '', '', '', '', '', '', '', '', '', '0000-00-00', '', '');
