...
// HTTP headers for no cache etc
	...
	private static function get_filefolder($rootdir = false, $filename = false, $fileid = false) {
		...
		return array('file' => JPATH_BASE . DS . 'attachments' . DS . $rootdir . DS . Files::makefilename($id), 'file_id' => $id);
	}
...
// Settings
		$targetDir = JPATH_BASE . DS . 'cache/tmp';
