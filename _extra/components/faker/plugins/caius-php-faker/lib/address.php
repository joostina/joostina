...
class Address extends Faker {
	...
	private static $_ru_states = array('Архангельск', 'Астрахань', 'Белгород', 'Благовещенск', 'Брянск', 'Чебоксары', 'Челябинск', 'Омск', 'Оренбург', 'Пенза', 'Пермь', 'Петрозаводск', 'Псков', 'Ростов-на-Дону', 'Рязань', 'Санкт-Петербург', 'Салехард', 'Саратов', 'Смоленск', 'Сочи', 'Ставрополь', 'Сургут', 'Сыктывкар', 'Тамбов', 'Томск', 'Тула', 'Тверь', 'Тюмень', 'Ульяновск', 'Владикавказ', 'Владимир', 'Владивосток', 'Волгоград', 'Вологда', 'Якутск', 'Ярославль', 'Екатеринбург',);
	...
	public function ru_state() {
		return parent::random(self::$_ru_states);
	}
