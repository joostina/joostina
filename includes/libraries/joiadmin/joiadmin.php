...
class JoiAdmin {
	 ...
	 *
	 * @param object JDBmodel $obj
	 * @param array $obj_list
	 * @param object mosPageNav $pagenav
	 * @param array $fields_list
	 */
	public static function listing(JDBmodel $obj, array $obj_list, mosPageNav $pagenav, array $fields_list) {
	...
	public static function get_listing_html_element(JDBmodel $obj, array $element_param, $key, $value, stdClass $values, $option) {
	 ...
	 * @param array $params
	 */
	public static function edit(JDBmodel $obj, $obj_data, $params = null) {
