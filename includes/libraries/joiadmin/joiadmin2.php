...
class JoiAdmin {
	...
	public static function dispatch() {
		...
		method_exists($class, 'init') ? call_user_func_array($class . '::init', array()) : null;
	...
	public static function listing(mosDBTable $obj, array $obj_list, mosPageNav $pagenav, array $fields_list) {
		...
		mosMainFrame::getInstance()->addJS(JPATH_SITE . '/includes/libraries/joiadmin/js/joiadmin.js');
