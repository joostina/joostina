...
class Votes extends JDBmodel {
    ...
    function __construct($obj_name) {
        $this->JDBmodel('#__votes_' . $obj_name, null); // FALSE - что бы не пытался обновлять несуществующие записи
 ...
 */
class VotesResult extends JDBmodel {
    ...
    function __construct($obj_name) {
        $this->JDBmodel('#__votes_' . $obj_name . '_results', 'id');
    }
