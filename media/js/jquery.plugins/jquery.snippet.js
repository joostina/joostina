...
(function($) {
    ...
    $.fn.snippet = function(language, settings) {
        ...
        return this.each(function() {
            ...
            if (node == "pre") {
                if (o.parent().attr("class").indexOf("snippet-wrap") == -1) {
                    ...
                    o.addClass("sh_" + language).wrap("<div class='sh_" + useStyle + " snippet-wrap' />");
    ...
    while (C < d) {
        ...
        for (; ;) {
            ...
            if (E === null) {
                ...
                switch (e[2]) {case -1:break;case -2:n.pop();break;case -3:n.length = 0;break;default:n.push(e);break
                }
            }
        }
        if (k) {
...
function sh_extractTagsFromNodeList(c, a) {
    ...
    for (var d = 0; d < f; d++) {
        var e = c.item(d);
        switch (e.nodeType) {case 1:if (e.nodeName.toLowerCase() === "br") {
            var b;
        ...
        }break;case 3:case 4:a.text.push(e.data);a.pos += e.length;break
        }
    }
}
