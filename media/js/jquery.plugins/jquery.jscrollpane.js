        ...
        function d(C, L) {
            ...
            function P() {
                ...
                C.attr("tabindex", 0).unbind("keydown.jsp").bind("keydown.jsp", function(aJ) {
                    ...
                    switch (aJ.keyCode) {case 40:S(H + aI, false);break;case 38:S(H - aI, false);break;case 34:case 32:J(aw() + Math.max(32, v) - 16);break;case 33:J(aw() - v + 16);break;case 35:J(W - v);break;case 36:J(0);break;case 39:T(X + aI, false);break;case 37:T(X - aI, false);break
                    }
                    if (!(aH == X && aG == H)) {
                        aF = true;
                        clearTimeout(s);
            ...
            b.extend(N, {reinitialise:function(aF) {
                aF = b.extend({}, aF, au);
                an(aF)
