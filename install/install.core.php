...
class joosInstall {
	...
	public static function check_db($host, $user, $pass, $db_name) {
		...
		if (!@mysql_connect($host, $user, $pass)) {
			return array('message' => 'Подключение к серверу базы данных провалено', 'success' => false);
		}

		if (!mysql_select_db($db_name)) {
			return array('message' => 'Выбор базы данных провален', 'success' => false);
		}

		return array('message' => 'Всё прекрасно', 'success' => true);
	}
