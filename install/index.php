...
$tests[]     = array ( 'title'       => __( 'Функция ini_set' ) ,
                       'required'    => FALSE ,
...
$tests[]     = array ( 'title'       => __( 'Функция контроля ошибок error_reporting' ) ,
                       'required'    => TRUE ,
...
$tests[]     = array ( 'title'        => __( 'Регистрация глобальных переменных' ) ,
                       'required'     => TRUE ,
...
$tests[]     = array ( 'title'       => __( 'Порядок обработки переменных' ) ,
                       'required'    => TRUE ,
...
$tests[]     = array ( 'title'        => __( 'Автостарт сессий' ) ,
                       'required'     => TRUE ,
...
$tests[]     = array ( 'title'        => __( 'Расширение PCRE' ) ,
                       'required'     => TRUE ,
...
$tests[] = array ( 'title'       => __( 'Поддержка mbstring' ) ,
                   'required'    => FALSE ,
                   'passed'      => extension_loaded( 'mbstring' ) ,
                   'description' => __( 'Поддержка mbstring является ключевым местом работы системы.' ) , );

$tests[] = array ( 'title'        => __( 'Переопределение системных функций через mbstring' ) ,
                   'required'     => TRUE ,
...
$tests[] = array ( 'title'        => __( 'Магические кавычки (Magic Quotes)' ) ,
                   'required'     => FALSE ,
...
$tests[] = array ( 'title'       => __( 'Расширение для кеширования Memcache' ) ,
                   'required'    => FALSE ,
...
$tests[] = array ( 'title'       => __( 'Расширение Fileinfo или mime_content_type()' ) ,
                   'required'    => FALSE ,
...
$tests[] = array ( 'title'        => __( 'Параметры HTTP_HOST или SERVER_NAME' ) ,
                   'required'     => TRUE ,
...
$tests[] = array ( 'title'        => __( 'Параметры REQUEST_URI или ORIG_PATH_INFO' ) ,
                   'required'     => TRUE ,
...
$tests[] = array ( 'title'        => __( 'Параметры SCRIPT_FILENAME, SCRIPT_NAME, PHP_SELF' ) ,
                   'required'     => TRUE ,
...
$tests[] = array ( 'title'        => __( 'Параметры SERVER_ADDR или LOCAL_ADDR' ) ,
                   'required'     => TRUE ,
