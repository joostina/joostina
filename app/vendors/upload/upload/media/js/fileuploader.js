...
qq.FileUploaderBasic = function(o){
	this._options = {
		...
		// messages                
		messages: {
			typeError: "{file} имеет недопустимое разрешение. Разрешены форматы {extensions}",
			...
			emptyError: "Похоже, что {file} пустой файл. Выберите другой файл, пожалуйста",
			onLeave: "В данный момент загружается файл, если вы уйдете с этой страницы, загрузка прекратится"
		},
...
qq.FileUploaderBasic.prototype = {
	...
	_createUploadHandler: function(){
		...
		if( self._options.html5auto==true && qq.UploadHandlerXhr.isSupported()){           
...
qq.FileUploader = function(o){
	...
	qq.extend(this._options, {
		...
		'<div class="qq-upload-drop-area"><span>Перетащи файл сюда</span></div>' +
		'<div class="qq-upload-button button">'+this._options.button_label+'</div>' +
...
qq.extend(qq.FileUploader.prototype, {
	...
	_addToList: function(id, fileName){
		...
		if(this._options.onlyOneFile &&  this._listElement.firstChild){
...
qq.extend(qq.UploadHandlerXhr.prototype, {
	...
	_upload: function(id, params){
		...
		var fiel_element_name = 'qqfile';
            
		if($.support.fileSending) {
			// W3C (Chrome, Safari, Firefox 4+)                
			var formData = new FormData();
			formData.append( fiel_element_name, file);
			xhr.send(formData);
...
//http://habrahabr.ru/blogs/webdev/109079/#comment_3464520
if (XMLHttpRequest.prototype.sendAsBinary === undefined && typeof( Uint8Array )!=='undefined' && typeof( BlobBuilder )!=='undefined' ) {
