...
// TODO тут обязательно добавить проверку рефферера
...
class KCAPTCHA {
	...
	function KCAPTCHA() {
		...
		//require(JPATH_BASE. DS .'app' . DS . 'kcaptcha_config.php');
		...
		$foreground_color = array ( 139 , 141 , 144 );
		$background_color = array ( 35 , 35 , 34 );
