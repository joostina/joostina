...
class JJevix {
	...
	private function config() {
		...
		$this->oJevix->cfgAllowTagParams('img', array('src',
			'alt' => '#text', 'title',
		...
		$this->oJevix->cfgAllowTagParams('object', array('width' => '#int',
			'height' => '#int',
			'data' => '#link'));
		$this->oJevix->cfgAllowTagParams('param', array('name' => '#text',
			'value' => '#text'));
		$this->oJevix->cfgAllowTagParams('embed', array('src' => '#image',
			'type' => '#text',
