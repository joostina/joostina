...
<div class="m-artist_about  block_sidebar">
    ...
    <ul class="m-artist-nav listreset">
        ...
        <li class="m-artist-nav_item"><a
                class="m-artist-nav_link el-star<?php echo (joosController::$controller == 'bookmarks' && joosController::$task == 'index') ? ' g-active' : null ?>"
                href="<?php echo joosRoute::href('bookmarks_user', array('username' => $user->username)) ?>">Закладки</a>
        </li>
