    ...
    <form action="/polls" method="post" class="poll_form" id="poll<?php echo $poll->id ?>">
        <fieldset>
            <div id="poll1_wrap">
                ...
                <table>
                    ...
                    foreach ($questions as $q_id => $q): ?>
                        <tr>
                            ...
                            <td>
                                <input class="required" type="radio" class="radio" id="a<?php echo $i ?>"
                                       value="<?php echo $v_id ?>" name="question[<?php echo $q_id ?>]"/>
                ...
                <br/><input type="submit" value="Отправить" class="submit"/><span class="poll_errors"
                                                                                  style="display: none;">Пожалуйста, сделайте выбор</span>
            </div>
        </fieldset>
    </form>
</div>