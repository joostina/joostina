...
?>
<div class="m-blogs">
	<h3 class="m-blogs_title">Новое в <a class="m-blogs_title_link" href="<?php echo joosRoute::href( 'blog' ) ?>"
	                                     title="Перейти в блог">блоге</a></h3>

	<ul class="listreset m-blogs_list">
		<?php foreach ( $items as $item ): ?>
		<?php $view_href = joosRoute::href( 'blog_view' , array ( 'id'       => $item->id ,
		                                                          'cat_slug' => $item->cat_slug ) ); ?>
		<?php $user_href = joosRoute::href( 'user_view' , array ( 'id'       => (int) $item->userid ,
