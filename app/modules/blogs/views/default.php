...
?>
	<div class="m-blogs">
		...
		<h3 class="m-blogs_title">Новое в <a class="m-blogs_title_link" href="#" title="Перейти в блог">блоге</a></h3>
		...
		<ul class="listreset m-blogs_list">
			...
			<li class="m-blogs_list_item">
				<h4 class="m-blogs_item_title"><a class="g-black_link" href="<?php echo $view_href ?>"><?php echo $item->title ?></a></h4>
