			...
			<li class="m-comments_list_item">
				<div class="comment_author">
					<a href="<?php echo $linkuser ?>" class="comment_author_link">
						<img class="g-thumb_40 g-user_avatar" src="<?php echo User::avatar($comment->user_id, '40x40') ?>" alt=""/>						
					</a>
				</div>
				<a class="comment_text" href="<?php echo $link_comment ?>"><?php echo Text::text_wrap(Text::character_limiter(Text::simple_clean($comment->comment_text), 70, '', 25), 25) ?>  [...]</a>
