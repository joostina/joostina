...
joosDocument::instance()
		->add_css(JPATH_SITE .'/app/templates/' . JTEMPLATE . '/media/css/template.css')
		->add_css(JPATH_SITE .  '/app/templates/' . JTEMPLATE . '/media/css/dropdown.css')
		//->addCSS(JPATH_SITE . '/media/js/jquery.ui/themes/ui-lightness/jquery-ui.css')
...
<body>
	...
	<div id="sidebar">
		<?php //joosModule::load_by_name('adminquickicons');?>
	</div>

		<div id="wrapper">
		
			<div id="header">
                <a href="index2.php?option=logout" class="logout_link"><?PHP echo _BUTTON_LOGOUT ?>
                    <?php echo $my->username; ?>
                </a>
				<div id="admin_menu"><?php joosModule::load_by_name('adminmenu'); //mosLoadAdminModule('adminmenu'); ?></div>
			</div><!-- #header-->
		...
		<div id="footer">
  			<div class="copyrights">
	        	<p><a href="#">Joostina CMS</a> &copy; 2007-2010</p>
	        	<p>ver. 2.0 a2</p>       	
	        </div>  
