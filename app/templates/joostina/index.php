...
<?php
joosDocument::instance()->add_js_file( JPATH_SITE . '/media/js/jquery.js' , array ( 'first' => true ) )->add_js_file( JPATH_SITE . '/media/js/jquery.tools.js' )->add_js_file( JPATH_SITE . '/media/js/jquery.plugins/jquery.form.js' )->add_js_file( JPATH_SITE . '/media/js/jquery.plugins/jquery.cookie.js' )->add_js_file( JPATH_SITE . '/media/js/jquery.plugins/jquery.localscroll.js' )->add_js_file( JPATH_SITE . '/media/js/valumsfileuploader/fileuploader.js' )->add_js_file( JPATH_SITE . '/media/js/jquery.plugins/jquery.scrollTo.js' )->add_js_file( JPATH_SITE . '/media/js/jquery.plugins/jquery.notifyBar.js' )->add_js_file( JPATH_SITE . '/media/js/jquery.plugins/jquery.placeholder.js' )->add_js_file( JPATH_SITE . '/media/js/jquery.plugins/jquery.validate.js' )->add_js_file( JPATH_SITE . '/app/components/comments/media/js/comments_tree.js' )->add_js_file( JPATH_SITE . '/app/templates/joostina/js/template.js?v=1' );
