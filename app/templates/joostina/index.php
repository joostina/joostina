...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		?>
		<!--[if IE 7]>
    		<link rel="stylesheet" href="<?php echo JPATH_SITE ?>/app/templates/joostina/css/ie.css" type="text/css" media="screen, projection" />
 		<![endif]-->		
	...
	<body  class="<?php echo $option ?> <?php echo $option != 'mainpage' ? 'inside' : '' ?>">
		...
		<div id="main_wrap">
			...
			<div id="header">
				...
				<div class="topmenu"><div class="wrapper"><?php joosModule::load_by_id(3); ?></div></div>
			</div>
			<!--[2]#header::END-->
			
			<!--[2]#promo::BEGIN-->
			<div id="promo"><div class="wrapper">
			...
			<div id="content_wrap">
						...
						<div id="component" class="frontpage">
							<?php if (joosController::$controller == 'mainpage'): ?>
								...
								<div class="module m-about">
									...
									<p>В первую очередь, Joostina - это русскоязычный OpenSource-проект, развивающийся силами безгранично любящих его людей. А во вторую очередь - это <strong>профессиональная, быстрая и современная система управления сайтами</strong>.</p>
				...
				</div></div><!--[3].container, #content::END--> 
				...
				<div id="sidebar">	
					...
					<div id="sidebar_content">	    	
						...
						<div class="module m-blog">
							<a class="h2" href="#">Новое в блоге</a>
							<ul class="listreset listblock listdotted">
								<li>
									<span class="el-comments_big"><a href="#comments">21</a></span>
									<a class="m-blog_link" href="#">Intel представила новейшие процессоры на 2010 год</a>
									<span class="el-date">12.02.2011 /</span>
									<a class="el-user" href="#">NickName</a>
								</li>
								<li>
									<span class="el-comments_big"><a href="#comments">21</a></span>
									<a class="m-blog_link" href="#">Intel представила новейшие процессоры на 2010 год</a>
