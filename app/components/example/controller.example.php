 ...
 *
 * */
class actionsExample extends joosController {

	public static function index() {

		$results = array();

		$results['joosCore::path'] = array("joosCore::path('example', 'controller');" => joosCore::path('example', 'controller'),
		...
		$results['joosLoader'] = array("joosLoader::model('example');" => joosLoader::model('example'),
		...
		$results['joosFile::file_info'] = array("joosFile::file_info( __FILE__ );" => joosFile::file_info(__FILE__),
		...
		$results['joosFile::make_file_location'] = array("joosFile::make_file_location( 1 );" => joosFile::make_file_location(1),
		...
		$results['joosFile::mime_content_type'] = array("joosFile::mime_content_type( __FILE__ );" => joosFile::mime_content_type(__FILE__),
		...
		$results['joosFile::exists'] = array("joosFile::exists( JPATH_BASE . DS. 'index.php' );" => joosFile::exists(JPATH_BASE . DS . 'index.php'),
			"joosFile::exists( JPATH_BASE . DS. 'non_exist_file.php');" => joosFile::exists(JPATH_BASE . DS . 'non_exist_file.php'),);

		$results['joosFile::convert_size'] = array("joosFile::convert_size( filesize(__FILE__) );" => joosFile::convert_size(filesize(__FILE__)),
	...
	private static function joosModulesException_example() {
		throw new joosModulesException('Произошла ошибка :custom_name потому как :desc', array(// пользовательские сообщения
