...
class adminBlog extends Blog {
	...
	public function get_fieldinfo() {
		return array ( 'id'          => array ( 'name'                     => 'id' ,
		               ...
		               'category_id' => array ( 'name'                     => 'Категория' ,
		                                        ...
		                                        'html_table_element_param' => array ( 'call_from' => 'Blog::get_blog_cats' ,
		                                                                              'width'     => '120px' , ) ,
		                                        'html_edit_element'        => 'option' ,
		                                        'html_edit_element_param'  => array ( 'call_from' => 'Blog::get_blog_cats' ) , ) ,
		               'user_id'     => array ( 'name'                     => 'Автор' ,
		                                        'editable'                 => true ,
		                                        'in_admintable'            => true ,
		                                        'html_table_element'       => 'value' ,
		                                        'html_table_element_param' => array () ,
		                                        'html_edit_element'        => 'edit' ) ,
		               'introtext'   => array ( 'name'                     => 'Текст вступления (без HTML)' ,
		                                        'editable'                 => true ,
		                                        'in_admintable'            => true ,
		                                        'html_table_element'       => 'value' ,
		                                        'html_table_element_param' => array () ,
		                                        'html_edit_element'        => 'wysiwyg' ,
		                                        'html_edit_element_param'  => array ( 'editor' => 'none' , ) ) ,
		               'fulltext'    => array ( 'name'                     => 'Полный текст записи (можно HTML)' ,
		                                        'editable'                 => true ,
		                                        'in_admintable'            => true ,
		                                        'html_table_element'       => 'value' ,
		                                        'html_table_element_param' => array () ,
		               ...
		               'params'      => array ( 'name'                     => 'Параметры' ,
		                                        ...
		                                        'html_table_element_param' => array () ,
		                                        'html_edit_element'        => 'edit' ) ,
		               'created_at'  => array ( 'name'                     => 'Дата создания' ,
		                                        'editable'                 => true ,
		                                        'in_admintable'            => true ,
		                                        'html_table_element'       => 'value' ,
		                                        'html_table_element_param' => array () ,
	...
	public function get_tableinfo() {
		return array ( 'header_list' => 'Блоги' ,
	...
	public function get_tabsinfo() {
		return array ( 'first'  => array ( 'title'  => 'Основное' ,
		                                   'fields' => array ( 'title' , 'state' , 'slug' , 'introtext' , 'fulltext' ) ) ,
		               'second' => array ( 'title'  => 'Расширенные' ,
...
class adminBlog_Category extends Blog_Category {
	...
	public function get_fieldinfo() {
		return array ( 'id'          => array ( 'name'                     => 'id' ,
		               ...
		               'slug'        => array ( 'name'                     => 'Ссылка' ,
		                                        ...
		                                        'html_table_element_param' => array () ,
		                                        'html_edit_element'        => 'edit' ) ,
		               'description' => array ( 'name'                     => 'Описание категории' ,
		                                        'editable'                 => true ,
		                                        'in_admintable'            => true ,
		                                        'html_table_element'       => 'value' ,
		                                        'html_table_element_param' => array () ,
	...
	public function get_tableinfo() {
		return array ( 'header_list' => 'Категории блогов' ,
