...
<ul class="listreset m-blogs_list">
	...
	<?php $href = joosRoute::href( 'blog_view' , array ( 'id'       => $blog_item->id ,
	                                                     'cat_slug' => $blog_item->cat_slug ) ); ?>
	<?php $user_href = joosRoute::href( 'user_view' , array ( 'id'       => $blog_item->userid ,
	                                                          'username' => $blog_item->username ) ) ?>
	...
	<li class="m-blogs_list_item">
		...
		<div class="m-blogs_author">
			<a href="<?php echo joosRoute::href( 'user_view' , array ( 'id'       => $blog_item->userid ,
			                                                           'username' => $blog_item->username ) ) ?>"
