...
$blog->fulltext  = Text::outlink_parse($blog->fulltext );
...
<div class="m-blogs_list_item full_item">
	...
	<div class="m-blogs_program">
		<span class="el-user"><a href="<?php echo joosRoute::href('user_view', array('username' => $user->username, 'id' => $user->id)) ?>"><?php echo $user->username ?></a></span>
