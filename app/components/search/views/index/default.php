...
?>
			...
			<form method="get" id="search_form" class="form_block" action="search/catalog/">
				<fieldset>
					...
					<div class="form_kitchen">
						<input type="radio" value="news" name="type" id="r_02" accesskey="i" /><label for="r_02">по новостям</label><br /><br />
					</div>
					<div class="cl"></div>
				</fieldset>
			</form>
			...
			<?php else: $count = count($results);  ?>
				...
				<p>По запросу “<?php echo $searchword ?>” найдено
					<span><?php echo $count ?></span> <?php echo Text::declension($count, array('результат', 'результата', 'результатов')) ?>
				</p>
					...
					<?php foreach($results as $item):
						...
						<div class="text_block_01">
							...
							<div class="block_name">
								1 <a href="<?php echo joosRoute::href('content_view', array('slug' => $item->slug))?>"><?php echo $item->title?></a>
