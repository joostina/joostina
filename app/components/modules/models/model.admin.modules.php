...
class adminModules extends modelModules {
	...
	public function get_fieldinfo() {
		return array('id' => array('name' => 'id',
			...
			'client_id' => array('name' => 'Тип',
				...
				'html_edit_element_param' => array('options' => array('0' => 'Модуль сайта',
			...
			'ordering' => array('name' => 'Порядок',
				...
				'html_table_element_param' => array('scope' => array('position'),
					'width' => '100px',
					'align' => 'center',
					'class' => 'ordering'),
				'html_edit_element' => 'edit',
				'html_edit_element_param' => array(),),
			'position' => array('name' => 'Позиция',
				'editable' => true,
				'in_admintable' => true,
				'html_table_element' => 'value',
				'html_table_element_param' => array(),
			...
			'content' => array('name' => 'Содержимое (HTML)',
				...
				'html_edit_element_param' => array(),),
			'%modules_pages' => array('name' => 'Где показывать',
				'editable' => true,
				'in_admintable' => true,
				'html_table_element' => 'value',
				'html_table_element_param' => array(),
	...
	public function get_tableinfo() {
		return array('header_main' => 'Модули',
			'header_list' => 'Модули',
	...
	public function get_extrainfo() {
		return array('search' => array('title'),
			'filter' => array('client_id' => array('name' => 'Область действия',
	...
	public static function get_modules_positions($item) {
		...
		$opt = $positions->get_selector(array("key" => "position",
			"value" => "position"));
