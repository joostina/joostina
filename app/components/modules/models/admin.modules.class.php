			...
			<?php foreach ($pages_list as $page): ?>
				...
				<div class="fields" title="<?php echo $i ?>">
					<div class="b b-left b-30">
						...
						<input class="b-90" name="pages[<?php echo $i ?>][controller]" type="text" value="<?php echo $page->controller ?>" />
					</div>

					<div class="b b-left b-30">
						<label class="b">Метод</label>
						<input class="b-90" name="pages[<?php echo $i ?>][method]" type="text" value="<?php echo $page->method ?>" />
					</div>				
