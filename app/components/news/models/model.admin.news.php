...
class adminNews extends News {
	...
	public function get_fieldinfo() {
		return array ( 'id'                     => array ( 'name'                     => 'id' ,
		               ...
		               'fulltext'               => array ( 'name'                     => 'Полный текст (с HTML)' ,
		                                                   ...
		                                                   'html_edit_element_param'  => array () , ) ,
		               'news_pictures_uploader' => array ( 'name'                    => 'Картинко' ,
		                                                   'editable'                => true ,
		                                                   'in_admintable'           => false ,
		                                                   'html_table_element'      => 'value' ,
		                                                   'html_edit_element'       => 'extra' ,
		                                                   'html_edit_element_param' => array ( 'call_from' => 'adminNews::get_picture_uploader' , ) , ) ,
	...
	public function get_tableinfo() {
		return array ( 'header_main' => 'Новости' ,
	...
	public function get_tabsinfo() {
		return array ( 'first'  => array ( 'title'  => 'Основное' ,
		                                   'fields' => array ( 'title' , 'created_at' , 'state' , 'slug' , 'introtext' , 'fulltext' , 'news_pictures_uploader' ) ) ,
		               'second' => array ( 'title'  => 'Метаданные' ,
		                                   'fields' => array ( 'metainfo' ) ) );
	}

	public function get_extrainfo() {
		return array ( 'search' => array ( 'title' , 'slug' ) , //			'filter' => array(
//				'type_id' => array(
//					'name' => 'Категория',
...
//			)
	...
	public function before_store() {
		...
		if ( $main_image_id ) {
			...
			$attach['main']    = array ( 'id'   => $main_image_id ,
