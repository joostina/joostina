...
class paramsNews {
	...
	public static function get_params_scheme( $type = '' ) {
		...
		$params['global'] = array ( 'item_image_size_big'    => array ( 'name'                    => 'Большое изображение' ,
		                                                                'editable'                => true ,
		                            ...
		                            'item_image_size_medium' => array ( 'name'                    => 'Средний эскиз' ,
		                                                                ...
		                                                                'html_edit_element'       => 'edit' ,
		                                                                'html_edit_element_param' => array () ) ,
		                            'item_image_size_thumb'  => array ( 'name'                    => 'Маленькое изображение' ,
		                                                                'editable'                => true ,
		                                                                'html_edit_element'       => 'edit' ,
		                                                                'html_edit_element_param' => array () ) ,
		                            'item_image_quality'     => array ( 'name'                    => 'Степень сжатия (от 0 до 100)' ,
		                                                                'editable'                => true ,
		                                                                'html_edit_element'       => 'edit' ,
		                                                                'html_edit_element_param' => array () ) ,
		                            'item_image_ext'         => array ( 'name'                    => 'Формат изображений-результатов' ,
		                                                                'editable'                => true ,
		                                                                'html_edit_element'       => 'edit' ,
		                                                                'html_edit_element_param' => array () ) ,
		                            'archive_eyars'          => array ( 'name'                    => 'Года для архива' ,
		                                                                'editable'                => true ,
		                                                                'html_edit_element'       => 'edit' ,
		                                                                'html_edit_element_param' => array () ) );
