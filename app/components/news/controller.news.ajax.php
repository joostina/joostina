...
class actionsNews extends joosController {
	...
	public static function index() {
		...
		//Превью
		//Сначала уменьшаем
		Thumbnail::output($file['basename'], $img . '/thumb.png', array('width' => 158, 'height' => 108, 'method' => THUMBNAIL_METHOD_SCALE_MIN));
		//а потом обрезаем
		Thumbnail::output($img . '/thumb.png', $img . '/thumb.png', array('width' => 158, 'height' => 108, 'method' => THUMBNAIL_METHOD_CROP));
