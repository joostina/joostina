...
class actionsAdminInstaller {
	...
	public static function action_before() {
		joosDocument::instance()->add_js_file( JPATH_SITE . '/media/js/valumsfileuploader/fileuploader.js' )->add_js_file( JPATH_SITE . '/administrator/components/installer/media/js/installer.js' );
	}
