...
<form action="/user/<?php echo $user->username ?>/edit" method="post" class="usereditform">
	...
	<div class="f-block odd">
		<div class="f  f-50 f-50_1">
			...
			<input type="text" name="location" value="<?php echo mosMakeHtmlSafe($user_e->location) ?>" class="input-100" />
		</div>
	</div>
	...
	<div class="f-block">
		<div class="f">
			...
			<textarea name="about[about]" rows="5" cols="50" class="input-100"><?php echo isset($about->about) ? $about->about : '' ?></textarea>
		</div>
	</div>	
	...
	<?php if ($user->gid == 9): ?>	
		<div class="f-block">
			<div class="f">
				...
				<textarea name="about[about2]" rows="5" cols="50" class="input-100"><?php echo isset($about->about2) ? $about->about2 : '' ?></textarea>
			</div>
		</div>
	<?php endif; ?>
	...
	<div class="f-block odd">
		...
		<div class="f f-50 f-50_2">
			...
			<?php
			$all_interests = UserExtra::get_interests();
			...
			<div id="contact_fields">
				...
				foreach ($contacts as $type => $values) {
					foreach ($values as $val) {
						echo '<div class="f">';
						echo forms::dropdown_simple('contact_type', UserExtra::get_contacts_types(), $type) . "\n";
	...
	<div class="f-block odd">
		...
		<div class="f f-50 f-50_2">
			...
			<div class="f-tip b-left b-50">старый пароль</div><div class="f-tip">новый пароль</div>
		</div>
	</div>
	...
	<div class="f-block">
		<div class="f f-50 f-50_1">
			...
			<a  class="button" href="<?php echo joosRoute::href('user_view', array('username' => $user->username)) ?>">Отмена</a>
		</div>
	</div>
	...
	<input type="hidden" id="image_id" name="params[image_id]" value="" />
		...
		<div class="f f-50 f-50_1" id="user_avatar_wrapper">	
			<img id="edit_avatar_img" src="<?php echo User::avatar($user->id, '75x75') ?>?<?php echo time() ?>" alt=""/>
