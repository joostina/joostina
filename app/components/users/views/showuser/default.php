...
<div class="artist-about b-gray">	
	...
	<div class="b-70 b-left">			
		<strong>Возраст:</strong> <?php echo $user->extra()->birthdate ? User::get_age($user->extra->birthdate) : ' не указан'; ?><br/>
		<strong>Местоположение:</strong> <?php echo $user->extra()->location ? $user->extra->location : ' не указано'; ?><br/>
