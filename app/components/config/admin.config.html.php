...
<div style="text-align:left;">
	<form action="index2.php" method="post" name="adminForm" id="adminForm">
		...
		<table width="100%">
			<tr>
				<td width="185"><?php echo mosToolTip(_TIME_OFFSET2." ".joosDate::current(_DATE_FORMAT_LC2),'','','',_TIME_OFFSET)?>:</td>
			...
			<tr>
				<td width="185"><?php echo mosToolTip(_CURR_DATE_TIME_RSS.": ".joosDate::current(_DATE_FORMAT_LC2),'','','',_TIME_DIFF2)?>:</td>
