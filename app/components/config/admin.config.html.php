...
class HTML_config {
	...
	public static function showconfig(&$row, &$lists, $option) {
				...
				<table width="100%">
					<tr>
						<td>
							<table class="sub_adminform">
								<tr>
									...
									<td><input class="text_area" style="width:98%;" type="text" name="config_sitename" size="50"
								...
								<tr>
									<td valign="top"><?php echo mosToolTip(_SITE_OFFLINE_MESSAGE2, '', '', '', _SITE_OFFLINE_MESSAGE); ?>
										:
									</td>
									<td><textarea class="text_area" cols="60" rows="2" style="width:98%; height:50px"
												  name="config_offline_message"><?php echo $row->config_offline_message; ?></textarea>
									</td>
								</tr>
								<tr>
									<td valign="top"><?php echo mosToolTip(_SYSTEM_ERROR_MESSAGE2, '', '', '', _SYSTEM_ERROR_MESSAGE); ?>
										:
									</td>
									<td><textarea class="text_area" cols="60" rows="2" style="width:98%; height:50px"
												  name="config_error_message"><?php echo $row->config_error_message; ?></textarea>
									</td>
								</tr>
							</table>
						</td>
						<td valign="top">
							<table class="sub_adminform">
								<tr>
									<td><?php echo mosToolTip(_ENABLE_USER_REGISTRATION2, '', '', '', _ENABLE_USER_REGISTRATION) ?>
										:
									</td>
		...
		?>
				<table width="100%">
					...
					<tr>
						...
						<td><input class="text_area" type="text" name="config_form_date" size="20"
								   value="<?php echo $row->config_form_date; ?>"/><?php echo $lists['form_date_help']; ?>
						</td>
					</tr>
					<tr>
						<td><?php echo mosToolTip(_DATE_FORMAT_FULL2, '', '', '', _DATE_FORMAT_FULL) ?>:</td>
						<td><input class="text_area" type="text" name="config_form_date_full" size="20"
								   value="<?php echo $row->config_form_date_full; ?>"/><?php echo $lists['form_date_full_help']; ?>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input class="text_area" type="text" name="config_favicon" size="20"
								   value="<?php echo $row->config_favicon; ?>"/></td>
					</tr>
					<tr>
				...
				<td valign="top">
					<table class="sub_adminform">
						...
						<tr>
							...
							<td><input class="text_area" type="text" name="config_lifetime" size="10"
									   value="<?php echo $row->config_lifetime; ?>"/> <?php echo _SECONDS ?></td>
						</tr>
						<tr>
				...
				<table width="100%">
					<tr>
						<td>
							<table class="sub_adminform">
								<tr>
									<td width="300"><?php echo mosToolTip(_DISABLE_ADMIN_SESS_DEL2, '', '', '', _DISABLE_ADMIN_SESS_DEL) ?>
										:
									</td>
									<td><?php echo $lists['config_admin_autologout']; ?></td>
								</tr>
								<tr>
									<td width="300"><?php echo mosToolTip(_ADMIN_SECURE_CODE_HELP, '', '', '', _ENABLE_ADMIN_SECURE_CODE) ?>
										:
									</td>
								...
								<tr>
									...
									<td><input class="text_area" type="text" name="config_admin_secure_code" size="60"
											   value="<?php echo $row->config_admin_secure_code; ?>"/></td>
								</tr>
								<tr>
									<td width="300"><?php echo mosToolTip(_ADMIN_SECURE_CODE_OPTION, '', '', '', _ADMIN_SECURE_CODE_REDIRECT_OPTIONS) ?>
										:
									</td>
									<td><?php echo $lists['config_admin_redirect_options']; ?></td>
								</tr>
								<tr>
									<td><?php echo mosToolTip(_ADMIN_SECURE_CODE_REDIRECT_PATH, '', '', '', _ADMIN_SECURE_CODE_REDIRECT_PATH) ?>
										:
									</td>
									<td><input class="text_area" type="text" name="config_admin_redirect_path" size="60"
											   value="<?php echo $row->config_admin_redirect_path; ?>"/></td>
								</tr>
								<tr>
									<td><?php echo _COM_CONFIG_COUNT_FOR_USER_BLOCK ?>:</td>
									<td><input class="text_area" type="text" name="config_count_for_user_block" size="10"
											   value="<?php echo $row->config_count_for_user_block; ?>"/></td>
								</tr>
							</table>
						</td>
						<td valign="top">
								...
								<tr>
									...
									<td>
										<input class="text_area" type="text" name="config_session_life_admin" size="10"
											   value="<?php echo $row->config_session_life_admin; ?>"/>&nbsp;<?php echo _SECONDS ?>
										&nbsp;
		<?php echo mosWarning(_ADMIN_SESS_TIME2); ?>
								...
								<tr>
									<td><?php echo mosToolTip(_COM_CONFIG_COMPONENTS_ACCESS_HELP, '', '', '', _COM_CONFIG_COMPONENTS_ACCESS) ?>
										:
									</td>
		...
		?>
				<table width="100%">
					<tr>
						<td width="185"><?php echo mosToolTip(_TIME_OFFSET2 . " " . joosDateTime::current(JDATE_FORMAT), '', '', '', _TIME_OFFSET) ?>
							:
						</td>
					...
					<tr>
						...
						<td><input class="text_area" type="text" name="config_offset" size="15"
								   value="<?php echo $row->config_offset; ?>" disabled="disabled"/></td>
					</tr>
					<tr>
						<td width="185"><?php echo mosToolTip(_CURR_DATE_TIME_RSS . ": " . joosDateTime::current(JDATE_FORMAT), '', '', '', _TIME_DIFF2) ?>
							:
						</td>
		...
		?>
				<table width="100%">
					...
					<tr>
						...
						<td><input class="text_area" type="text" name="config_db" size="25" value="<?php echo $row->config_db; ?>"/>
						</td>
					</tr>
					<tr>
						<td><?php echo _DB_PREFIX ?>:</td>
						<td><input class="text_area" type="text" name="config_dbprefix" size="10"
								   value="<?php echo $row->config_dbprefix; ?>"/>&nbsp;<?php echo mosWarning(_DB_PREFIX2); ?></td>
					</tr>
					<tr>
						...
						<td>
							<table class="sub_adminform">
								...
								<tr>
									...
									<td><input class="text_area" type="text" name="config_media_dir" size="50"
											   value="<?php echo $row->config_media_dir; ?>"/></td>
								</tr>
								<tr>
											...
											<table cellpadding="1" cellspacing="1" border="0">
												<tr>
													<td><input type="radio" id="filePermsMode0" name="filePermsMode" value="0"
															   onclick="changeFilePermsMode(0)"<?php if (!$mode)
								echo ' checked="checked"'; ?>/>
												...
												<tr>
													<td><input type="radio" id="filePermsMode1" name="filePermsMode" value="1"
															   onclick="changeFilePermsMode(1)"
		<?php if ($mode)
			echo ' checked="checked"'; ?>/></td>
													<td>
														<label for="filePermsMode1"><?php echo _FILE_MODE4 ?></label>
														<span id="filePermsValue"<?php if (!$mode)
			echo ' style="display:none"'; ?>>
															<input class="text_area" type="text" readonly="readonly"
		                                                           name="config_fileperms" size="4"
		                                                           value="<?php echo $row->config_fileperms; ?>"/>
														</span>
														<span id="filePermsTooltip"<?php if ($mode)
			echo ' style="display:none"'; ?>>
														...
														<table cellpadding="0" cellspacing="1" border="0">
															<tr>
																...
																<td style="padding:0px"><input type="checkbox" id="filePermsUserRead"
																							   ...
																							   onclick="saveFilePerms()"<?php if ($flags & 0400)
			echo ' checked="checked"'; ?>/>
																</td>
																<td style="padding:0px"><label
																		for="filePermsUserRead"><?php echo _O_READ ?></label></td>
																<td style="padding:0px"><input type="checkbox" id="filePermsUserWrite"
																							   name="filePermsUserWrite" value="1"
																							   onclick="saveFilePerms()"<?php if ($flags & 0200)
			echo ' checked="checked"'; ?>/>
																</td>
																<td style="padding:0px"><label
																		for="filePermsUserWrite"><?php echo _O_WRITE ?></label></td>
																<td style="padding:0px"><input type="checkbox" id="filePermsUserExecute"
																							   name="filePermsUserExecute" value="1"
																							   onclick="saveFilePerms()"<?php if ($flags & 0100)
			echo ' checked="checked"'; ?>/>
																</td>
																<td style="padding:0px" colspan="3"><label
																		for="filePermsUserExecute"><?php echo _O_EXEC ?></label></td>
															</tr>
															<tr>
																...
																<td style="padding:0px"><input type="checkbox" id="filePermsGroupRead"
																							   ...
																							   onclick="saveFilePerms()"<?php if ($flags & 040)
			echo ' checked="checked"'; ?>/>
																</td>
																<td style="padding:0px"><label
																		for="filePermsGroupRead"><?php echo _O_READ ?></label></td>
																<td style="padding:0px"><input type="checkbox" id="filePermsGroupWrite"
																							   name="filePermsGroupWrite" value="1"
																							   onclick="saveFilePerms()"<?php if ($flags & 020)
			echo ' checked="checked"'; ?>/>
																</td>
																<td style="padding:0px"><label
																		for="filePermsGroupWrite"><?php echo _O_WRITE ?></label></td>
																<td style="padding:0px"><input type="checkbox" id="filePermsGroupExecute"
																							   name="filePermsGroupExecute" value="1"
																							   onclick="saveFilePerms()"<?php if ($flags & 010)
			echo ' checked="checked"'; ?>/>
																</td>
																<td style="padding:0px" width="70"><label
																		for="filePermsGroupExecute"><?php echo _O_EXEC ?></label></td>
		...
		<?php echo _APPLY_TO_FILES ?>
																		&nbsp;
		<?php echo mosWarning(_APPLY_TO_FILES2); ?>
																	</label>
																</td>
															</tr>
															<tr>
																...
																<td style="padding:0px"><input type="checkbox" id="filePermsWorldRead"
																							   ...
																							   onclick="saveFilePerms()"<?php if ($flags & 04)
			echo ' checked="checked"'; ?>/>
																</td>
																<td style="padding:0px"><label
																		for="filePermsWorldRead"><?php echo _O_READ ?></label></td>
																<td style="padding:0px"><input type="checkbox" id="filePermsWorldWrite"
																							   name="filePermsWorldWrite" value="1"
																							   onclick="saveFilePerms()"<?php if ($flags & 02)
			echo ' checked="checked"'; ?>/>
																</td>
																<td style="padding:0px"><label
																		for="filePermsWorldWrite"><?php echo _O_WRITE ?></label></td>
																<td style="padding:0px"><input type="checkbox" id="filePermsWorldExecute"
																							   name="filePermsWorldExecute" value="1"
																							   onclick="saveFilePerms()"<?php if ($flags & 01)
			echo ' checked="checked"'; ?>/>
																</td>
																<td style="padding:0px" colspan="4"><label
																		for="filePermsWorldExecute"><?php echo _O_EXEC ?></label></td>
															</tr>
														</table>
													</td>
												</tr>
											...
											<table cellpadding="1" cellspacing="1" border="0">
												<tr>
													<td><input type="radio" id="dirPermsMode0" name="dirPermsMode" value="0"
															   onclick="changeDirPermsMode(0)"<?php if (!$mode)
										echo ' checked="checked"'; ?>/>
													</td>
												...
												<tr>
													<td><input type="radio" id="dirPermsMode1" name="dirPermsMode" value="1"
															   onclick="changeDirPermsMode(1)"<?php if ($mode)
										echo ' checked="checked"'; ?>/>
													</td>
													<td>
														<label for="dirPermsMode1"><?php echo _DIR_CREATION4 ?></label>
														<span id="dirPermsValue"<?php if (!$mode)
										echo ' style="display:none"'; ?>>
		<?php echo _O_AS ?>: <input class="text_area" type="text"
																	 readonly="readonly"
																	 name="config_dirperms" size="4"
																	 value="<?php echo $row->config_dirperms; ?>"/>
														</span>
														<span id="dirPermsTooltip"<?php if ($mode)
			echo ' style="display:none"'; ?>>
														...
														<table cellpadding="1" cellspacing="0" border="0">
															<tr>
																...
																<td style="padding:0px"><input type="checkbox" id="dirPermsUserRead"
																							   ...
																							   onclick="saveDirPerms()"<?php if ($flags & 0400)
			echo ' checked="checked"'; ?>/>
																</td>
																<td style="padding:0px"><label
																		for="dirPermsUserRead"><?php echo _O_READ ?></label></td>
																<td style="padding:0px"><input type="checkbox" id="dirPermsUserWrite"
																							   name="dirPermsUserWrite" value="1"
																							   onclick="saveDirPerms()"<?php if ($flags & 0200)
			echo ' checked="checked"'; ?>/>
																</td>
																<td style="padding:0px"><label
																		for="dirPermsUserWrite"><?php echo _O_WRITE ?></label></td>
																<td style="padding:0px"><input type="checkbox" id="dirPermsUserSearch"
																							   name="dirPermsUserSearch" value="1"
																							   onclick="saveDirPerms()"<?php if ($flags & 0100)
			echo ' checked="checked"'; ?>/>
																</td>
																<td style="padding:0px" colspan="3"><label
																		for="dirPermsUserSearch"><?php echo _O_SEARCH ?></label></td>
															</tr>
															<tr>
																<td style="padding:0px"><?php echo _GROUP ?>:</td>
																<td style="padding:0px"><input type="checkbox" id="dirPermsGroupRead"
																							   name="dirPermsGroupRead" value="1"
																							   onclick="saveDirPerms()"<?php if ($flags & 040)
			echo ' checked="checked"'; ?>/>
																</td>
																<td style="padding:0px"><label
																		for="dirPermsGroupRead"><?php echo _O_READ ?></label></td>
																<td style="padding:0px"><input type="checkbox" id="dirPermsGroupWrite"
																							   name="dirPermsGroupWrite" value="1"
																							   onclick="saveDirPerms()"<?php if ($flags & 020)
			echo ' checked="checked"'; ?>/>
																</td>
																<td style="padding:0px"><label
																		for="dirPermsGroupWrite"><?php echo _O_WRITE ?></label></td>
																<td style="padding:0px"><input type="checkbox" id="dirPermsGroupSearch"
																							   name="dirPermsGroupSearch" value="1"
																							   onclick="saveDirPerms()"<?php if ($flags & 010)
			echo ' checked="checked"'; ?>/>
																</td>
																<td style="padding:0px" width="70"><label
																		for="dirPermsGroupSearch"><?php echo _O_SEARCH ?></label></td>
		...
		<?php echo mosWarning(_APPLY_TO_DIRS2); ?>
															...
															<tr>
																...
																<td style="padding:0px"><input type="checkbox" id="dirPermsWorldRead"
																							   ...
																							   onclick="saveDirPerms()"<?php if ($flags & 04)
			echo ' checked="checked"'; ?>/>
																</td>
																<td style="padding:0px"><label
																		for="dirPermsWorldRead"><?php echo _O_READ ?></label></td>
																<td style="padding:0px"><input type="checkbox" id="dirPermsWorldWrite"
																							   name="dirPermsWorldWrite" value="1"
																							   onclick="saveDirPerms()"<?php if ($flags & 02)
			echo ' checked="checked"'; ?>/>
																</td>
																<td style="padding:0px"><label
																		for="dirPermsWorldWrite"><?php echo _O_WRITE ?></label></td>
																<td style="padding:0px"><input type="checkbox" id="dirPermsWorldSearch"
																							   name="dirPermsWorldSearch" value="1"
																							   onclick="saveDirPerms()"<?php if ($flags & 01)
			echo ' checked="checked"'; ?>/>
																</td>
																<td style="padding:0px" colspan="3"><label
																		for="dirPermsWorldSearch"><?php echo _O_SEARCH ?></label></td>
															</tr>
														</table>
													</td>
												</tr>
						...
						<td>
							<table class="sub_adminform">
								<tr>
									...
									<td><textarea class="text_area" cols="50" rows="3" style="width:85%; height:60px"
						...
						<td valign="top">
							<table class="sub_adminform">
								...
								<tr>
									...
									<td><input class="text_area" type="text" name="config_mtage_revisit" size="10"
											   value="<?php echo $row->config_mtage_revisit; ?>"/></td>
								</tr>
								<tr>
		...
		<?php } ?>
		            ...
		            <tr id="memcache_server" <?php echo ($row->config_cache_handler != 'memcache') ? "style='display: none;'" : ""; ?>>
		                ...
		                <td><?php echo _HOST; ?>:
		                    <input class="text_area" type="text" id="config_memcache_host" name="config_memcache_host" size="25"
		                           value="<?php echo $row->config_memcache_host; ?>"/>
		                    <br/><br/>
					<?php echo _PORT; ?>:
		                    <input class="text_area" type="text" id="config_memcache_port" name="config_memcache_port" size="6"
		                           value="<?php echo $row->config_memcache_port; ?>"/>
		                </td>
		            </tr>
		            <tr>
		                <td><?php echo _CACHE_TIME ?>:</td>
		                <td><input class="text_area" type="text" name="config_cachetime" size="5"
		                           value="<?php echo $row->config_cachetime; ?>"/> <?php echo _SECONDS ?></td>
		            </tr>
					<?php
					if (is_writeable($row->config_cachepath)) {
						?>
		...
		?>
		            <tr>
		                ...
		                <td><input type="text" READONLY name="config_cache_key_false" size="50" disable="true"
		                           value="<?php echo $row->config_cache_key; ?>"/>
		            </tr>
		            <tr>
		                <td><?php echo _CACHE_DIR ?>:</td>
		                <td><input class="text_area" type="text" name="config_cachepath" size="50"
		...
		?>
				<table width="100%">
					...
					<tr>
						...
						<td><input class="text_area" type="text" name="config_tseparator" size="5"
								   value="<?php echo $row->config_tseparator; ?>"/></td>
					</tr>
					<tr>
		...
		?>
				<table width="100%">
					<tr>
						...
						<td><input class="text_area" style="width:60px;" type="text" name="config_admin_bad_auth" size="60"
								   value="<?php echo $row->config_admin_bad_auth; ?>"/></td>
					</tr>
					<tr>
