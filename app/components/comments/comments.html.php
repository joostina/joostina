		...
		<ul class="comment_menu">
			<li class="comment_avatar">
				<a class="avatar_small" href="<?php echo $linkuser; ?>">
					<img class="g-thumb_40 g-user_avatar" src="<?php echo User::avatar($comment->user_id, '40x40') ?>" alt="<?php echo $comment->user_name ?>" />
				</a>
			</li>
			...
			<li class="comment_href">
				<a name="comment<?php echo $comment->id ?>" class="unajax" href="<?php echo $link_comment ?>" id="comment<?php echo $comment->id ?>">#<?php echo $comment->id ?></a>
			</li>
