 ...
 */
require_once JPATH_BASE . DS . 'core' . DS . 'libraries' . DS . 'Zend' . DS . 'Acl' . DS . 'Resource' . DS . 'Interface.php';


/**
 * @see Zend_Acl_Role_Registry
 */
require_once JPATH_BASE . DS . 'core' . DS . 'libraries' . DS . 'Zend' . DS . 'Acl' . DS . 'Role' . DS . 'Registry.php';

/**
 * @see Zend_Acl_Assert_Interface
 */
require_once JPATH_BASE . DS . 'core' . DS . 'libraries' . DS . 'Zend' . DS . 'Acl' . DS . 'Assert' . DS . 'Interface.php';

/**
 * @see Zend_Acl_Role
 */
require_once JPATH_BASE . DS . 'core' . DS . 'libraries' . DS . 'Zend' . DS . 'Acl' . DS . 'Role.php';
...
class Zend_Acl {
	 ...
	 * @var array
	 */
	protected $_rules = array ( 'allResources' => array ( 'allRoles' => array ( 'allPrivileges' => array ( 'type'   => self::TYPE_DENY ,
	                                                                                                       'assert' => null ) ,
	                                                                            'byPrivilegeId' => array () ) ,
	                                                      'byRoleId' => array () ) ,
	                            'byResourceId' => array () );
						...
						if ( 0 === count( $privileges ) ) {
							if ( null === $resource && null === $role ) {
								if ( $type === $rules['allPrivileges']['type'] ) {
									$rules = array ( 'allPrivileges' => array ( 'type'   => self::TYPE_DENY ,
									                                            'assert' => null ) ,
									                 'byPrivilegeId' => array () );
								}
								continue;
