...
class joosAutoadmin
{
    ...
    public static function edit(joosModel $obj, $obj_data, $params = null)
    {
        ...
        if (!$params) {
            $params = array(//'wrap_begin' => '<table class="admin_form joiadmin">',
                ...
                'label_begin' => '<div class="control-group">', 'label_end' => '', 'el_begin' => '<div class="controls">', 'el_end' => '</div></div>');
    ...
    public static function get_count(joosModel $obj)
    {
        ...
        $params = array('where' => $header_extra['wheres'], 'only_count' => true);
    ...
    {
        return array(0 => 'Не активно', 1 => 'Активно');
    }
