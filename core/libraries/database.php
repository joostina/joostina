...
class joosModel
{
     ...
     * @return bool
     */
    public function set_state_group(array $cid = null, $state = 1)
    {
        if (count($cid) < 1) {
     ...
     */
    public function get_max_by_field($name)
    {
    ...
    // @todo обновление неограниченного числа записей
    public function update_all( $attributes, $condition, $params )
    {
    }
