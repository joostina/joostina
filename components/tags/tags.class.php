...
class Tags extends JDBmodel {
	 ...
	 * @param JDBmodel $obj требуемый объект
	 * @return string html код ссылок-тэгов
	 */
	function show_tags(JDBmodel $obj) {
	...
	public static function get_tag_url($tag, $group = '') {
		return Jroute::href('tags_view',  array('tag'=>$tag) );
	}
