 ...
 * Модель Comments
 */
class Comments extends JDBmodel {
	...
	public function load_comments($obj, $limit = 10, $visible_pages = 10) {
		...
		Jdocument::getInstance()
				...
				->addJS(JPATH_SITE . '/components/comments/media/js/comments.js');
	}
	...
	public function load_comments_tree($obj) {
		...
		require_once joosCore::path('comments', 'html');
		...
		Jdocument::getInstance()
				...
				->addJS(JPATH_SITE . '/components/comments/media/js/comments_tree.js', array('last' => true));
