...
Jdocument::$data['footer'][] = $register_js_code;
    ...
    <div class="menu_inside_submenu">
        <ul class="menu_inside_submenu_ul active_ul by_statuses">
            <li class="menu_inside_submenu_active">
				<span>
					<a title="Регистрация" href="<?php echo Jroute::href('register') ?>">Регистрация</a>
				</span>
			</li>
            <li>
				<span>
					<a title="Восстановление пароля" href="<?php echo Jroute::href('lostpassword') ?>">Восстановление пароля</a>
                </span>
			</li>
        </ul>       
    </div> 

    <form action="<?php echo Jroute::href('register') ?>" method="post" id="reg_form">
